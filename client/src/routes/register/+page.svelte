...
{#if !data.authenticated}
	<main class="page">
		...
		<div class="card">
			...
			<div class="controls">
				<button class="btn fs-body ripple yellow-rp" on:click={() => navigate_to('/login')}>
					<p>Login</p>
				</button>
				<button
					class="btn fs-body active white-rp ripple"
					on:click={() => navigate_to('/register')}
				>
					<p>Register</p>
				</button>
			</div>
			<div class="form">
				...
				/>
				<button
					class="btn fs-body white-rp ripple"
					on:click={() => register()}
					disabled={isLoading}
				>
					<p>Register</p>
